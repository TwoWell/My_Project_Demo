      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-for="(propsInfo, index) in searchParams.props" :key="index">{{
              propsInfo.split(":")[1]
        ...
        <!--selector-->
        <SearchSelector @brandInfo="brandInfo" @getAttrsInfo="getAttrsInfo" />
        <!--details-->
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: oderisOne }" @click="changeOder('1')">
                  <a>综合<span v-show="oderisOne" class="iconfont"
                      :class="{ 'icon-angle-double-up': oderisUp, 'icon-angle-double-down': oderisDown }"></span></a>
                </li>
                <li :class="{ active: oderisTwo }" @click="changeOder('2')">
                  <a>价格<span v-show="oderisTwo" class="iconfont"
                      :class="{ 'icon-angle-double-up': oderisUp, 'icon-angle-double-down': oderisDown }"></span></a>
                </li>
              </ul>
            </div>
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="(goods, _) in goodsList" :key="goods.id">
                <div class="list-wrap">
                  <div class="p-img">
...
export default {
  ...
  methods: {
    ...
    brandInfo(brand) {
      //如果通过搜索框筛选了，点击品牌图标搜索同样的名字就不发请求了，避免面包屑上有多个同样的标签
      if (this.searchParams.keyword == brand.tmName) {
        return
      }
    ...
    getAttrsInfo(attrsList, attrsValue) {
